...
1. **Fork the repository**
   Create a personal copy of the repository by [forking it on GitHub](https://github.com/LukeHackett/gradle-secrets-plugin/fork). You can make changes in your fork and submit a pull request.

2. **Clone your fork**
   Clone the forked repository to your local machine:
   ```bash
   git clone https://github.com/your-username/gradle-secrets-plugin.git
   ```
